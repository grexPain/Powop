package com.gr.griep.powop.blocks.teleporter;
...
public class PowopTeleporter extends Teleporter {
    ...
    public PowopTeleporter(WorldServer world, double x, double y, double z) {
        super(world);
