...
public class ImpactGrenade extends Item {
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn,
        ...
        if (!worldIn.isRemote)
        {
            EntityImpactGrenade entityImpactGrenade = new EntityImpactGrenade(worldIn, playerIn);
            entityImpactGrenade.setHeadingFromThrower(playerIn, playerIn.rotationPitch, playerIn.rotationYaw, 0.0F, 1.5F, 1.0F);
            worldIn.spawnEntityInWorld(entityImpactGrenade);
        }
